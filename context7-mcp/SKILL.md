---
name: context7-mcp
description: Use when a request depends on current library, framework, SDK, API, CLI, or cloud-service documentation, including setup, configuration, migration, debugging, and version-specific code examples.
---
...
- **Protect secrets**: Remove tokens, passwords, private endpoints, and other credentials before sending queries to Context7
